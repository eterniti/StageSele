package action_script
{
   ...
   public class CountDownTimer
   {
      ...
      {
         var _loc6_:int = 0;
         var _loc3_:* = param1 <= this.m_warn_count;
         ...
         while(_loc5_ <= DigitMax)
         {
            if(0 <= _loc4_)
            {
               if(this.m_mc_counter["nmb_" + _loc5_])
               {
                  _loc6_ = _loc4_ % 10 + 1;
                  if(_loc3_)
                  {
                  ...
                  this.m_mc_counter["nmb_" + _loc5_].nmb01.gotoAndStop(_loc6_);
               }
               _loc4_ = _loc4_ / 10;
            }
            if(param2)
            {
               if(this.m_mc_counter["nmb_" + _loc5_])
               {
                  this.m_mc_counter["nmb_" + _loc5_].gotoAndPlay(param2);
               }
            }
            _loc5_++;
         }
